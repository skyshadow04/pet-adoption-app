...
export default function PetProfile() {
  ...
  return (
    <>
        <NavigationBar />
        <div className="flex flex-col items-center justify-center min-h-screen px-4 bg-gradient-to-br from-orange-100 via-white to-blue-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
        <div className="relative bg-white/90 dark:bg-gray-900/90 shadow-2xl rounded-3xl p-10 max-w-md w-full mt-16 mb-16 overflow-hidden">
            ...
            <p className="text-gray-500 dark:text-gray-400 text-center mb-4">{age}</p>
            </div>
            <div className="mb-6">
